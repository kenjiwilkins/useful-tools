...
export const tools: Tool[] = [
  ...
  },
  {
    slug: 'word-counter',
    title: 'Word Counter',
    description: 'Count words, characters, sentences, and paragraphs. Get reading time estimates.',
    category: 'Text',
    icon: 'AlignLeft',
    available: false,
  },
  ...
  },
  {
    ...
    description: 'Prettify, minify, and validate JSON. Inspect nested structures at a glance.',
    category: 'Data',
    icon: 'Braces',
    available: false,
  },
...
export const CATEGORIES: ToolCategory[] = ['Text', 'Numbers', 'Data', 'Encoding', 'Dev'];
